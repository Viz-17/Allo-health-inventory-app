    ...
    >
      <span
        style={{
          ...
          borderRadius: "50%",
          background: color,
          animation: status === "PENDING" ? "pulse-badge 2s ease-in-out infinite" : "none",
        }}
      />
      {label}
    </span>
    ...
    <div style={{ maxWidth: "520px", margin: "0 auto", padding: "2rem 1.5rem" }}>
      ...
      >
        ...
        <div style={{ padding: "1.5rem" }}>
              ...
              <div key={label}>
                ...
                <dd
                  style={{
                    ...
                    fontWeight: 500,
                    fontFamily:
                      label === "Quantity" || label === "Total" || label === "Unit price"
                        ? "DM Mono, monospace"
                        : "inherit",
                  }}
                >
          ...
          {/* Success/terminal state messages */}
            ...
            <div style={{ display: "flex", gap: "8px" }}>
              ...
              <button
                ...
                style={{
                  ...
                  border: "none",
                  background:
                    actionLoading === "confirm" ? "rgba(99,102,241,0.7)" : "#6366f1",
                  color: "#fff",
                  fontSize: "0.9rem",
                  fontWeight: 600,
                  cursor: actionLoading ? "not-allowed" : "pointer",
